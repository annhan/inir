...
""" %(os.path.join(paths.IMAGEDIR,'lcnc_swoop.png'))
    ...
    def init_pins(self):
        ...
        pin = self.h.newpin("changescara", hal.HAL_FLOAT, hal.HAL_IN)
    ...
    def init_widgets(self):
        ...
        self.w.slider_maxv_ovr.setValue(8000)
        #info= "Check 3001 - "
        ...
        self.w.slider_feed_ovr.setValue(200)
...
#                    QtCore.Qt.Key_F3,QtCore.Qt.Key_F4,QtCore.Qt.Key_F5):
    ...
    def hard_limit_tripped(self, obj, tripped, list_of_tripped):
        print("hard_limit_tripped",tripped)
    ...
    def _check_override_limits(self,state,data):
        print("_check_override_limits",data)
        if 0 in data:
            self.w.chk_override_limits.setChecked(False)
        else:
            self.w.chk_override_limits.setChecked(True)
    ...
    def btn_jog_run_clicked(self):
        ...
        typekins = self.h['stsKins.scaraKins'] 
        if (joint == 2):
            MODE_JOG = True # True la lINEAER can kiem tr axem jog joint thi switch mode thanh False
        elif typekins == 1:
            MODE_JOG = False # True la lINEAER can kiem tr axem jog joint thi switch mode thanh False
        else:
            MODE_JOG = True # True la lINEAER can kiem tr axem jog joint thi switch mode thanh False
        self.kb_jog(1, joint, direct, 1, MODE_JOG) # 1 la
    ...
    def btn_jog_stop_clicked(self):
        ...
        if (joint == 2):
            ...
            MODE_JOG = True # True la lINEAER can kiem tr axem jog joint thi switch mode thanh False
        self.kb_jog(0, joint, direct, 1, MODE_JOG)
